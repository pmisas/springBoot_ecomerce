...
public class ItemService {
    ...
    public Item saveItem(Long idUser, ItemDTO item) {
        User user = userRepository.findById(idUser).orElseThrow(() -> new NotFoundException("User not found with ID: " + idUser));
    ...
    public Item getItemById(Long id) {
        return itemRepository.findById(id).orElseThrow(() -> new NotFoundException("Item not found with ID: " + id));
    }
